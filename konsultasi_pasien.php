...
<table width="99%" border="0" cellpadding="0" cellspacing="1" bgcolor="#22B5DD">
	...
	<tr> 
	  <td bordercolor="#9999FF" bgcolor="#CCFF33" class="style14"><span class="style15">  + <a href="index.php">DAFTAR NARKOBA</a> </a></span></td>
	</tr>
	...
	<tr>
	  <td bordercolor="#9999FF" bgcolor="#CCFF33"><span class="style16">+ <a href="pakar/login.php" target="_blank">LOGIN PAKAR</a></span></td>
	</tr>
